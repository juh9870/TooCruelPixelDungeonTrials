...
import com.shatteredpixel.shatteredpixeldungeon.tcpd.windows.TestWindow;
...
//		add(btnSupport);
		...
		btnRankings = new StyledButton(GREY_TR,Messages.get(this, "tcpd_recent_games")){
			@Override
			protected void onClick() {
		...
		btnNews.enable(DeviceCompat.isDebug());
		add(btnNews);
